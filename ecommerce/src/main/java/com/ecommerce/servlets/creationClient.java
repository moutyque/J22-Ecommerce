...
public class creationClient extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (client.getPrenom().isEmpty() || client.getNom().isEmpty() || client.getAdresse().isEmpty()
			...
			message ="Erreur - Vous n'avez pas rempli tous les	champs obligatorie !<br> <a	href=\"http://localhost:8080/ecommerce/clientCreation\">Cliquer ici</a>	pour accéder au formulaire de création d'un client";
